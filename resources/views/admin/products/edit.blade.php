            ...
            <form id="form-update-product" class="form-update-product" method="POST"
                ...
                <div class="section-content layout-variants" id="layout-variants">
                    ...
                    <div class="layout-applied-data-checkbox">
                        ...
                        <div class="applied-data-field">
                            <input type="checkbox" id="variants_thumb_url" name="variants_thumb_url" value="{{ ModelMetaKey::THUMB_URL }}">
                ...
                <div class="section-content layout-siblings" id="layout-siblings">
                    ...
                    <div class="layout-applied-data-checkbox">
                        ...
                        <div class="applied-data-field">
                            ...
                            <label for="siblings_title" class="applied-data-label">Title</label>
                        </div>

                        <div class="applied-data-field">
                            <input type="checkbox" id="siblings_type" name="siblings_type" value="type">
                            <label for="siblings_type" class="applied-data-label">Type</label>
                        </div>

                        <div class="applied-data-field">
                            <input type="checkbox" id="siblings_parent_id" name="siblings_parent_id" value="parent_id">
                            <label for="siblings_parent_id" class="applied-data-label">Parent id</label>
                        </div>

                        <div class="applied-data-field">
                            <input type="checkbox" id="siblings_status" name="siblings_status" value="status">
                            <label for="siblings_status" class="applied-data-label">Status</label>
                        </div>

                        <div class="applied-data-field">
                            <input type="checkbox" id="siblings_description" name="siblings_description"
                                value="description">
                            <label for="siblings_description" class="applied-data-label">Description</label>
                        </div>
                        ...
                        <div class="applied-data-field">
                            <input type="checkbox" id="siblings_top_tags" name="siblings_top_tags"
                                value="{{ ModelMetaKey::TOP_TAGS }}">
                            <label for="siblings_top_tags" class="applied-data-label">Top tags</label>
                        </div>

                        <div class="applied-data-field">
                            <input type="checkbox" id="siblings_thumb_url" name="siblings_thumb_url" value="{{ ModelMetaKey::THUMB_URL }}">
                            <label for="siblings_thumb_url" class="applied-data-label">Thumb url</label>
                        </div>
                        ...
                        <div class="applied-data-field">
                            ...
                            <label for="siblings_bottom_left_stamp_url" class="applied-data-label">Bottom left stamp
                                url</label>
                        </div>
                        ...
                        <div class="applied-data-field">
                            <input type="checkbox" id="siblings_top_right_stamp_url" name="siblings_top_right_stamp_url"
                                value="{{ ModelMetaKey::TOP_RIGHT_STAMP_URL }}">
                            <label for="siblings_top_right_stamp_url" class="applied-data-label">Top right stamp
                                url</label>
                        </div>

                        <div class="applied-data-field">
                            <input type="checkbox" id="siblings_badge" name="siblings_badge" value="{{ ModelMetaKey::BADGE }}">
                            <label for="siblings_badge" class="applied-data-label">Badge</label>
                        </div>

                        <div class="applied-data-field">
                            <input type="checkbox" id="siblings_compare_tags" name="siblings_compare_tags"
                                value="{{ ModelMetaKey::COMPARE_TAGS }}">
                            <label for="siblings_compare_tags" class="applied-data-label">Compare tags</label>
                        </div>

                        <div class="applied-data-field">
                            <input type="checkbox" id="siblings_regular_price" name="siblings_regular_price"
                                value="{{ ModelMetaKey::REGULAR_PRICE }}">
                            <label for="siblings_regular_price" class="applied-data-label">Regular price</label>
                        </div>

                        <div class="applied-data-field">
                            <input type="checkbox" id="siblings_price" name="siblings_price" value="{{ ModelMetaKey::PRICE }}">
                            <label for="siblings_price" class="applied-data-label">Price</label>
                        </div>

                        <div class="applied-data-field">
                            <input type="checkbox" id="siblings_gift" name="siblings_gift" value="{{ ModelMetaKey::GIFT }}">
                            <label for="siblings_gift" class="applied-data-label">Gift</label>
                        </div>
                    </div>
                    <x-product.list.index>

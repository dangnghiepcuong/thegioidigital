...
<div id="component-product-list-flash-sale">
    ...
    <div class="nav-slider">
        <div class="prev" onclick="navigateSlider('#frame-slider-grid-product-sale', 'left', 5, 12)">
            <div class="arrow arrow-left"></div>
        </div>
        <div class="next" onclick="navigateSlider('#frame-slider-grid-product-sale', 'right', 5, 12)">

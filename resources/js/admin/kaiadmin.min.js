...
function customBackgroundColor() {
    $('*[data-background-color="custom"]').each(function () {
        $(this).is("[custom-color]") ? $(this).css("background",
            $(this).attr("custom-color")) : $(this).is("[custom-background]") && $(this).css("background-image",
...
function legendClickCallback(e) {
    ...
    var a = s.parentElement,
        o = parseInt(a.classList[0].split("-")[0],
            10),
        r = Chart.instances[o],
        l = Array.prototype.slice.call(a.children).indexOf(s);
    r.legend.options.onClick.call(r,
        e,
        r.legend.legendItems[l]),
...
function readURL(e) {
    if (e.files && e.files[0]) {
        ...
        s.onload = function (s) {
            $(e).parent(".input-file-image").find(".img-upload-preview").attr("src",
                s.target.result)
        },
...
function showPassword(e) {
    ...
    "password" === s.attr("type") ? s.attr("type",
        "text") : s.attr("type",
            "password")
}
$(".main-header .logo-header").html(logoHeaderContent),
    $(".nav-search .input-group > input").focus(function (e) { $(this).parents().eq(2).addClass("focus") }).blur(function (e) { $(this).parents().eq(2).removeClass("focus") }),
    $(function () {
    ...
    $(document).ready(function () {
        ...
        t.length > 0 && t.scrollbar(),
            $("#search-nav").on("shown.bs.collapse",
                function () {
        ...
        $(".wrapper").hasClass("is-show") && (C = 1,
            ...
            $(".messages-contact .user a").on("click",
                function () {
                    $(".tab-chat").addClass("show-chat")
                }),
            $(".messages-wrapper .return").on("click",
                function () {
...
function changeContainer() {
    !0 == showSignIn ? containerSignIn.css("display",
        "block") : containerSignIn.css("display",
            "none"),
        !0 == showSignUp ? containerSignUp.css("display",
            "block") : containerSignUp.css("display",
                "none")
}
